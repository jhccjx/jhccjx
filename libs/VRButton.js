...
class VRButton{
    ...
    button.style.top = '50%';
    button.style.transform = 'translateX(-50%, -50%)'; // Adjust position to center it horizontally
    ...
    button.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" fill="currentColor" class="bi bi-headset-vr" viewBox="0 0 16 16">
